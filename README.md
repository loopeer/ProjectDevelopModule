...
```groovy
dependencies {
    compile 'com.loopeer.library:compatinset:0.0.5-beta35'
}
```
||Api16|Api19|Api23|
|---|---|---|---|
...
```groovy
dependencies {
    compile 'com.loopeer.library:bottomdialog:0.0.5-beta35'
}
```
#### Usages
```java
...
```groovy
dependencies {
    compile 'com.loopeer.library:addresspicker:0.0.5-beta35'
}
```
#### Usages
```java
...
```groovy
dependencies {
    compile 'com.loopeer.library:developutil:0.0.5-beta35'
}
```
#### Usages
##### ClickSpanHelper
...
```groovy
dependencies {
    compile 'com.loopeer.library:imageswitcher:0.0.5-beta35'
}
```
...
```groovy
dependencies {
    compile 'com.loopeer.library:appupdate:0.0.5-beta35'
}
```
