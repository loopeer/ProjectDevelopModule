...
```groovy
dependencies {
    compile 'com.loopeer.library:compatinset:0.0.5-beta10'
}
```
||Api16|Api19|Api23|
|---|---|---|---|
...
```groovy
dependencies {
    compile 'com.loopeer.library:bottomdialog:0.0.5-beta10'
}
```
#### Usages
```java
...
```groovy
dependencies {
    compile 'com.loopeer.library:addresspicker:0.0.5-beta10'
}
```
#### Usages
```java
...
```groovy
dependencies {
    compile 'com.loopeer.library:developutil:0.0.5-beta10'
}
```
#### Usages
##### ClickSpanHelper
...
```groovy
dependencies {
    compile 'com.loopeer.library:imageswitcher:0.0.5-beta10'
}
```
...
```groovy
dependencies {
    compile 'com.loopeer.library:appupdate:0.0.5-beta10'
}
```
