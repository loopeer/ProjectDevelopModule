...
public class PickerBottomBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public PickerBottomBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * A utility function to get the {@link PickerBottomBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link PickerBottomBehavior}.
     * @return The {@link PickerBottomBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> PickerBottomBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
            .getBehavior();
        if (!(behavior instanceof PickerBottomBehavior)) {
            throw new IllegalArgumentException(
                "The view is not associated with BottomSheetBehavior");
        }
        return (PickerBottomBehavior<V>) behavior;
    }
