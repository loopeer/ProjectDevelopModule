...
public abstract class AbstractFormItemView extends ForegroundLinearLayout implements FormItemView {
    ...
    @Override public void setDescText(CharSequence desc) {
        mDescText.setText(desc);
    }

    @Override public void setDecText(@StringRes int StringResId) {
        mDescText.setText(StringResId);
    }

    @Override public void setDescTextColor(@ColorInt int color) {
        mDescText.setTextColor(color);
    }

    @Override public Editable getDescText() {
        return (Editable) mDescText.getText();
    }

    @Override public void setDescTextDrawableLeft(Drawable drawable) {
        mDescText.setCompoundDrawablesWithIntrinsicBounds(drawable, null, null, null);
    }

    @Override public void setDescTextDrawableLeft(@DrawableRes int resDrawable) {
        mDescText.setCompoundDrawablesWithIntrinsicBounds(resDrawable, 0, 0, 0);
    }

    @Override public void setDescMinWidth(@Px int minWidth) {
        mDescText.setMinWidth(minWidth);
    }

    @Override public void setDescTextMinEms(int minEms) {
        mDescText.setMinEms(minEms);
    }

    @Override public void setContentHint(CharSequence hint) {
        mContentText.setHint(hint);
    }

    @Override public void setContentMaxLines(int max) {
        mContentText.setMaxLines(max);
    }

    @Override public void setContentHintTextColor(@ColorInt int color) {
        mContentText.setHintTextColor(color);
    }

    @Override public void setContentTextColor(@ColorInt int color) {
        mContentText.setTextColor(color);
    }

    @Override public void setContentText(CharSequence content) {
    ...
    @Override public void setContentTextSize(float size) {
        mContentText.setTextSize(COMPLEX_UNIT_PX,size);
    }

    @Override public void setContentTextDrawableRight(Drawable drawable) {
        mContentText.setCompoundDrawablesWithIntrinsicBounds(null, null, drawable, null);
    }

    @Override public void setContentTextDrawableRight(@DrawableRes int resDrawable) {
        mContentText.setCompoundDrawablesWithIntrinsicBounds(0, 0, resDrawable, 0);
    }

    @Override public void setContentMaxLength(int max) {
        mContentText.setMaxLines(max);
    }

    @Override public void removeContentTextChangedListener(TextWatcher watcher) {
        mContentText.removeTextChangedListener(watcher);
    }

    @Override public void addContentTextChangedListener(TextWatcher watcher) {
